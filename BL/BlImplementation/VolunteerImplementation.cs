            ...
            if (currentAssignment != null)
            {
                ...
                if (callDetails != null) {
                    callInProgress = new BO.CallInProgress
                    {
                        ...
                        VolunteerResponseDistance = Tools.CalculateDistance(doVolunteer.Latitude ?? double.MaxValue, doVolunteer.Longitude ?? double.MaxValue, callDetails.Latitude, callDetails.Longitude),
